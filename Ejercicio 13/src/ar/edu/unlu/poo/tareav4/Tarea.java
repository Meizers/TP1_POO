...
public class Tarea {
    ...
    private LocalDate fecha_finalizada = null;
    private String colaborador = null;
    ...
    public LocalDate get_fecha_limite(){
        return fecha_limite;
    }

    public LocalDate get_fecha_finalizada(){
        if (completada){
    ...
    public void completar(String colaborador, LocalDate fecha_finalizada){
